    ...
    return (
      <Grid>
        <Row style={{display: props.mileTimes.length > 0 ? "flex" : "none"}}>
          ...
          <Col>
            <Profile style={{display: props.mileTimes.length > 0 ? "inline=" : "none", height: "20%", width: "30%"}}  coordinates={props.coordinates} mileTimes={props.mileTimes} stops={props.stops}></Profile>
